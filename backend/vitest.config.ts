  ...
  test: {
    ...
    coverage: {
      ...
      include: [
        ...
        "src/services/cached-exchange-rate.provider.ts",
        "src/services/fixed-exchange-rate.provider.ts",
        "src/services/frankfurter-exchange-rate.provider.ts",
        "src/services/create-exchange-rate-provider.ts",
      ...
      exclude: [
        "**/*.test.ts",
        "src/domain/compensation.types.ts",
        "src/domain/analytics.types.ts",
        "src/domain/insights/executor-context.ts",
        "src/domain/insights/index.ts",
      ],
      thresholds: {
        lines: 95,
        functions: 95,
