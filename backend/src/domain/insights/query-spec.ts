...
import { hasEmployeeScope } from "./employee-scope.js";
import { isInsightTimelineIntent } from "./timeline/timeline.js";
...
export const ALL_INSIGHT_QUERY_METRICS = [
  "AVG_DEPT_SALARY",
  "MEDIAN_DEPT_SALARY",
  "HEADCOUNT",
  "TOTAL_PAYROLL",
...
] as const satisfies readonly InsightQueryMetric[];

export const ALL_INSIGHT_QUERY_FILTER_DIMENSIONS = [
  "country",
  "department",
  "jobTitle",
  "months",
  "sinceDate",
  "limit",
] as const satisfies readonly InsightQueryFilterDimension[];
